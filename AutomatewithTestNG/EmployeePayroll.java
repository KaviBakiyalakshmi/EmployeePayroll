...
public class EmployeePayroll {
	...
	public void userTest() throws InterruptedException {
		...
		//User Attendance
		wd.findElement(By.xpath("/html/body/app-root/app-userdashboard/div[1]/div[2]/div[1]/div[2]/a")).click();
		Thread.sleep(1000);
		wd.findElement(By.xpath("/html/body/app-root/app-user-attendance/div/div[1]/button")).click();
		Thread.sleep(1000);
		
		//User salary
		wd.findElement(By.xpath("/html/body/app-root/app-userdashboard/div[1]/div[2]/div[1]/div[3]/a")).click();
		Thread.sleep(5000);
		wd.navigate().to("http://localhost:4200/userdashboard");
		
		//User Leave
		wd.findElement(By.xpath("/html/body/app-root/app-userdashboard/div[1]/div[2]/div[1]/div[1]/a")).click();
		Thread.sleep(1000);
		//Apply leave
		wd.findElement(By.xpath("/html/body/app-root/app-userdashboard/div[1]/div[2]/div[1]/div[1]/ul/li[1]/a")).click();
		Thread.sleep(1000);
		...
		wd.findElement(By.xpath("/html/body/app-root/app-userdashboard/div[1]/div[2]/div[1]/div[1]/a")).click();
		Thread.sleep(1000);
		wd.findElement(By.xpath("/html/body/app-root/app-userdashboard/div[1]/div[2]/div[1]/div[1]/ul/li[2]/a")).click();
		Thread.sleep(3000);
		wd.findElement(By.xpath("/html/body/app-root/app-leave-status/button")).click();
		Thread.sleep(3000);
...
//		Thread.sleep(2000);
		...
		//Logout
		wd.findElement(By.xpath("/html/body/app-root/app-userdashboard/div[1]/div[1]/div/div/a")).click();
		wd.findElement(By.xpath("/html/body/app-root/app-userdashboard/div[1]/div[1]/div/div/ul/li[2]/a")).click();
		Thread.sleep(2000);
	...
	public void adminTest() throws InterruptedException {
		...
		// Login Credentials
		wd.findElement(By.id("exampleInputEmail1")).sendKeys("renny@gmail.com");
		wd.findElement(By.id("exampleInputPassword1")).sendKeys("renny");
		wd.findElement(By.xpath("/html/body/app-root/app-login/div/div/div/div/form/form/button")).click();
		Thread.sleep(3000);
		wd.switchTo().alert().accept();
		Thread.sleep(1000);
